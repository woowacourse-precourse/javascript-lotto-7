...
**로또 출력시**
`이건 random함수 자체가 unique해서 고려안해도 될것같은데 혹시 모르니 구현한다`
* 출력된 로또번호가 6개가 아니면 예외처리한다.✅
* 출력된 로또중 중복된 번호가 있다면 예외처리한다.✅
* 로또 번호는 1부터 45사이의 숫자여야한다.✅

**당첨 로또 입력시**
* 쉼표가 string에 포함되어있어야 한다.✅
* 로또 출력시의 예외사항 그대로 적용 ✅

**보너스 금액 입력시**
* 입력값이 숫자이지 않으면 예외처리한다.✅
* 입력값이 양수이지 않으면 예외처리한다.✅
* 숫자 범위가 1~45에 해당하지 않으면 예외처리한다.✅
