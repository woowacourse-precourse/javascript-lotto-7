...
###  💵 로또 발매기 
사용자가 로또 구입 금액과 당첨 번호, 보너스 번호를 입력하면 당첨 내역을 알려주는 로또 발매기 입니다. 
<br/>
<br/>
...
- 2] 발행한 로또 리스트
    - [ ]  이후 구매한 로또 번호들을 배열로 보여준다.
    - [ ]  로또 한 장에 6개 숫자로 이루어져 있다.
    - [ ]  로또 번호는 오름차순으로 정렬하여 보여준다.
        - e.g. [8, 21, 23, 41, 42, 43]
- 3] 당첨 내역
    - [ ]  ‘당첨 통계\n’를 출력한다.
    - [ ]  ‘—-’ 구분선도 함께 출력한다.
    - [ ]  로또 번호가 맞는 갯수에 해당하는 맞은 갯수를 보여준다
        - 3개 일치 (5,000원) - {0}개
        - 4개 일치 (50,000원) - {0}개
...
- 사용자가 잘못된 값을 입력할 경우 "[ERROR]"로 시작하는 메시지와 함께 `Error`를 발생시키고 해당 메시지를 출력한 다음 해당 지점부터 다시 입력을 받는다.
    - 구입 금액 에러 처리
        - [ ]  1,000원으로 나누어 떨어지지 않는 경우 예외 처리한다.
            - [ ]  ‘1,000원 단위로 입력해주세요..’
    - 당첨 번호 에러 처리
        - [ ]  쉼표(,) 이외에 숫자가 아닌 경우  에러 처리 한다.
            - [ ]  
        - [ ]  숫자 길이가 6길이가 아닐 시 에러 처리 한다.
            - [ ]  ‘숫자는 6개만 입력해주세요.’
    - 보너스 번호 에러 처리
        - [ ]  숫자가 아닌 경우 에러 처리 한다.
            - [ ]  ‘숫자로 입력해 주세요.’
        - [ ]  숫자 길이가 1개가 아닌 경우 에러 처리 한다.
            - [ ]  ‘한 개의 숫자만 입력해 주세요.’
