...
- [ ] 구입 금액 입력 받기
  ...
  - [ ] 아무것도 입력하지 않은 경우(0원 포함) 예외 처리

  - [ ] 1,000원으로 나누어 떨어지지 않는 경우 예외 처리

  - [ ] 구입 금액이 100,000원(10만원)을 넘는 경우 예외 처리

- [ ] 구매한 로또 개수 출력하기
- [ ] 구매한 로또 개수만큼 로또 발급받고 출력하기
- [ ] 당첨 번호 입력 받기

  - [ ] 길이가 6이 아닌 경우 예외 처리

  - [ ] 중복이 있는 경우 예외 처리
  - [ ] 당첨 번호가 정수가 아닌 경우 예외 처리
  - [ ] 당첨 번호가 로또 범위가 아닌 경우 예외 처리

- [ ] 보너스 번호 입력 받기

  - [ ] 보너스 번호가 정수가 아닌 경우 예외 처리

  - [ ] 보너스 번호가 당첨 번호에 포함되는 경우 예외 처리
  - [ ] 보너스 번호가 로또 범위가 아닌 경우 예외 처리
