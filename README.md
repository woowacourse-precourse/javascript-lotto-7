...
- [x] 보너스 번호 입력 시, 숫자 범위(1~45)가 아닌 경우 예외 처리한다.
  - [ERROR] 로또 번호는 1부터 45 사이의 숫자여야 합니다.
- [x] 당첨 번호 입력 시, 쉼표(,)를 기준으로 구분하지 않은 경우 예외 처리한다.
- [x] 당첨 번호 입력 시, 숫자가 아닌 값을 입력한 경우 예외처리 한다.
- [x] 보너스 번호 입력 시, 숫자가 아닌 값을 입력한 경우 예외처리 한다.
...
- [x] 보너스 번호 입력 시, 입력한 번호가 중복되는 경우 예외 처리한다.
