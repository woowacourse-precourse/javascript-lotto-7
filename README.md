...
- [x] 보너스 번호를 입력 받는다.
- [x] 당첨 번호 추첨 시 중복되지 않는 숫자 6개와 보너스 번호 1개를 뽑기 (사용자 번호 입력)
...
- [x] 보너스 번호를 검증
  ...
  - 예외
    ...
    - [x] 음수, 0
    - [x] 1~45 범위를 벗어나는 경우
    - [x] 당첨번호에 있는 수와 중복되는 수면 안됨

## 3. 로또 일치 확인

- [x] 당첨기준에 맞게 조건 세우기
- [x] `로또 발행 번호` 와 `사용자가 뽑은 번호` 가 같은지 확인
  - [x] 당첨은 1등 ~ 5등. 당첨 기준과 금액은 아래와 같다.
  - 1등: 6개 번호 일치 / 2,000,000,000원
  - 2등: 5개 번호 + 보너스 번호 일치 / 30,000,000원
  - 3등: 5개 번호 일치 / 1,500,000원
  - 4등: 4개 번호 일치 / 50,000원
  - 5등: 3개 번호 일치 / 5,000원
- [x] 일치하면 당첨내역에 개수 추가
- [x] 당첨내역에 있는 개수 \* 당첨금액 총합 구하기
- [x] 로또 사는데 쓴 금액(투자금액) 과 수익금으로 수익률 구하기
