...
- 당첨 번호
    ...
    - [ ] 숫자 6개를 입력하지 않을 경우 에러 처리 한다. (1, 3, 5, 6, 7)
    - [ ] 숫자가 1에서 45까지가 아닐 경우 에러 처리 한다. (1, 3, 4, 5, 46, 7)
    - [ ] 6개 숫자 모두 컴마로 구분하지 않은 경우 에러 처리 한다. (1. 3, 4, 5, 46, 7)
    - [ ] 숫자가 중복되는 경우 에러 처리 한다. (1, 1, 2, 3, 4, 5)
