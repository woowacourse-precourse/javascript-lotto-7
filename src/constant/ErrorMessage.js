const ErrorMessages = {
    ...
    LOTTO_MONEY_MUST_NUMBER: "[ERROR] 구입 금액은 숫자여야 합니다.",
    LOTTO_MONEY_POSITIVE: "[ERROR] 구입 금액은 1000원 이상의 양수여야 합니다.",
    LOTTO_MONEY_MULTIPLE_THOUSAND: "[ERROR] 구입 금액은 1000원 단위여야 합니다.",
