...
export function purchasePriceValidate(purchasePrice) {
...
export function winningNumbersValidate(winningNumbers) {
...
export function bonusNumbersValidate(bonusNumber) {
...
export function bonusNumbersValidateWithWinningNumber(bonusNumber, winningNumber) {
