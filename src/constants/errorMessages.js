const ERR_MESSAGE_NUMBERS = {
  ...
  IS_NOT_NEGATIVE_NUMBER: "[ERROR] 음의 정수만 입력할 수 있습니다. 다시 입력해주세요.",
  TOO_LONG_LENGTH_NUMBER: `[ERROR] 숫자입력 6자리를 초과할 수 없습니다. 다시 입력해주세요.`,
  LIMIT_RANGE_NUMBER: `[ERROR] 숫자는 최소 1,000원부터 최대 100,000원 사이의 값으로 입력할 수 있습니다. 다시 입력해주세요.`,
  TOO_EXCESSIVE_NUMBER:
    "[ERROR] 과도한 숫자를 입력하셨습니다. 다시 입력해주세요.",
  INPUT_KILO_UNIT: "[ERROR] 천원단위로만 입력이 가능합니다. ex) 1000, 3000, 20000, 50000..."
