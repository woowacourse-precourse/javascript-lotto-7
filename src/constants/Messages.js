...
export const ERROR_MESSAGES = Object.freeze({
  ...
  invalidWinningNumberLength: `${ERROR_PREFIX} 로또 번호는 ${VALUES.lottoLength}개여야 합니다.`,
  invalidBonusNumberLength: `${ERROR_PREFIX} 보너스 번호는 ${VALUES.bonusNumberLength}개여야 가능합니다.`,
