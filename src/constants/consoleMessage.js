...
export const MESSAGES = Object.freeze({
  ...
  MATCH_COUNT_FIFTH_PRIZE: (count) => `3개 일치 (5,000원) - ${count}개`,
  MATCH_COUNT_FOURTH_PRIZE: (count) => `4개 일치 (50,000원) - ${count}개`,
  MATCH_COUNT_THIRD_PRIZE: (count) => `5개 일치 (1,500,000원) - ${count}개`,
  MATCH_COUNT_SECOND_PRIZE: (count) =>
    `5개 일치, 보너스 볼 일치 (30,000,000원) - ${count}개`,
  MATCH_COUNT_FIRST_PRIZE: (count) => `6개 일치 (2,000,000,000원) - ${count}개`,
