...
const ERROR_MESSAGE = Object.freeze({
  PURCHASE_PRICE_EMPTY: '[ERROR] 구매 금액을 입력해주세요.',
  PURCHASE_PRICE_NAN: '[ERROR] 로또는 숫자로만 구매할 수 있습니다. (예시: 100000)',
  PURCHASE_PRICE_NOT_DIVIDE_1000: '[ERROR] 로또는 1000원 단위로 구매해야 합니다.',
  PURCHASE_PRICE_NOT_INTEGER: '[ERROR] 로또는 정수값으로 입력해야 합니다.',
  PURCHASE_PRICE_TOO_LARGE: '[ERROR] 구매 금액이 너무 큽니다.',
  PURCHASE_PRICE_TOO_SMALL: `[ERROR] 구매 금액은 최소 ${LOTTO_CONFIG.TICKET_PRICE}원 이어야 합니다.`,
  PURCHASE_PRICE_NEGATIVE: '[ERROR] 로또 구입 금액은 음수일 수 없습니다.',
