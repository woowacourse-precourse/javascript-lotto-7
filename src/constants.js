export const ERROR_MESSAGES = {
  INVALID_AMOUNT: "[ERROR] 구입 금액은 숫자로만 이루어져야 합니다.",
  ...
  WINNING_NUMBERS_NAN: "[ERROR] 당첨 번호는 숫자로만 이루어져야 합니다.",
  WINNING_NUMBERS_COUNT: "[ERROR] 당첨 번호는 6개여야 합니다.",
  WINNING_NUMBERS_DUPLICATE: "[ERROR] 당첨 번호는 중복될 수 없습니다.",
  WINNING_NUMBERS_RANGE: "[ERROR] 당첨 번호는 1에서 45 사이의 숫자여야 합니다.",
  BONUS_NUMBER_NAN: "[ERROR] 보너스 번호는 숫자여야 합니다.",
  BONUS_NUMBER_COUNT: "[ERROR] 보너스 번호는 1개여야 합니다.",
