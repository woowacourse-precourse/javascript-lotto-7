...
const Errors = Object.freeze({
  ...
  BasicNumbers: {
    NO_INPUT: `당첨 번호를 입력받지 못했어요.\n6개의 숫자를 ${InputComment.Seperator.NAME}(${InputComment.Seperator.VALUE})로 구분하여 입력해주세요.`,
    IS_WRONG_LENGTH: `숫자의 갯수가 맞지 않습니다.\n6개의 숫자를 ${InputComment.Seperator.NAME}(${InputComment.Seperator.VALUE})로 구분하여 입력해주세요.`,
    IS_DUPLICATED_VALUE_IN: `번호들 중 중복되는 값이 있어요.\n중복되지 않는 숫자를 ${InputComment.Seperator.NAME}(${InputComment.Seperator.VALUE})로 구분하여 입력해주세요.`,
  },

  BasicEachNumber: {
    NO_INPUT: `입력하지 않은 숫자가 있습니다.\n6개의 숫자를 ${InputComment.Seperator.NAME}(${InputComment.Seperator.VALUE})로 구분하여 입력해주세요.`,
    NOT_NUMBER_INPUT: `숫자들 중 문자가 있습니다.\n문자가 아닌 숫자를 ${InputComment.Seperator.NAME}(${InputComment.Seperator.VALUE})로 구분하여 입력해주세요.`,
    NOT_RANGED_INPUT: `숫자들 중 범위에 맞지 않은 숫자가 있습니다.\n1부터 45사이의 숫자를 ${InputComment.Seperator.NAME}(${InputComment.Seperator.VALUE})로 구분하여 입력해주세요.`,
  },

  BonusNumber: {
    NO_INPUT:
      '보너스 번호를 입력받지 못했어요.\n1개의 숫자를 당첨 번호와 중복되지 않게 입력해주세요.',
    NOT_NUMBER_INPUT:
      '보너스 번호는 숫자로 입력해야 합니다.\n다시 입력해주세요.',
    NOT_RANGED_INPUT:
      '보너스 번호는 1부터 45 사이의 숫자이어야 합니다.\n다시 입력해주세요.',
