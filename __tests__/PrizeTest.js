...
describe('Prize 클래스 테스트', () => {
  ...
  test.each([
    {matchingNumber: 3, price: 5000, isBonus: false, log: '3개 일치 (5,000원) - 0개'},
    {matchingNumber: 4, price: 50000, isBonus: false, log: '4개 일치 (50,000원) - 0개'},
    {matchingNumber: 5, price: 1500000, isBonus: false, log: '5개 일치 (1,500,000원) - 0개'},
    {matchingNumber: 5, price: 30000000, isBonus: true, log: '5개 일치, 보너스 볼 일치 (30,000,000원) - 0개'},
    {matchingNumber: 6, price: 2000000000, isBonus: false, log: '6개 일치 (2,000,000,000원) - 0개'},
