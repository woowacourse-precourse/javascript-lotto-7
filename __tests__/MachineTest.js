...
describe('로또 테스트', () => {
  ...
  it.each([
    [
      [1, 2, 3, 4, 5, 6],
      ['1000', '1,2,3,4,5,6', undefined],
      '[ERROR] 보너스 번호를 입력해 주세요.',
    ],
    [
      [1, 2, 3, 4, 5, 6],
      ['1000', '1,2,3,4,5,6', null],
      '[ERROR] 보너스 번호를 입력해 주세요.',
    ],
    [
      [1, 2, 3, 4, 5, 6],
    ...
    [
      [1, 2, 3, 4, 5, 6],
      ['1000', '1,2,3,4,5,6', '-1'],
      '[ERROR] 보너스 번호는 양의 정수로만 구성되어야 합니다.',
    ],
    [
      [1, 2, 3, 4, 5, 6],
      ['1000', '1,2,3,4,5,6', '1.2'],
      '[ERROR] 보너스 번호는 양의 정수로만 구성되어야 합니다.',
    ],
    [
      [1, 2, 3, 4, 5, 6],
      ['1000', '1,2,3,4,5,6', '100j'],
      '[ERROR] 보너스 번호는 양의 정수로만 구성되어야 합니다.',
    ],
    [
      [1, 2, 3, 4, 5, 6],
      ['1000', '1,2,3,4,5,6', '0'],
      '[ERROR] 보너스 번호는 숫자는 1부터 45 사이의 숫자여야 합니다.',
    ],
    [
      [1, 2, 3, 4, 5, 6],
      ['1000', '1,2,3,4,5,6', '46'],
  ...
  ])('보너스 번호 예외 테스트', async (random, input, output) => {
    await runException(random, input, output);
  });
});
