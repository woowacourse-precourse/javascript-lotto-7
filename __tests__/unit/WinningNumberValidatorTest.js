import validateWinningNumber from '../../src/validators/WinningNumberValidatior';
...
describe("validateWinningNumber() 테스트", () => {
  ...
  test.each([
    ...
    expect(() => validateWinningNumbersInput(input)).toThrow(TAGS.ERROR);
  });
  ...
  test.each([
    ...
    expect(() => validateWinningNumbersInput(input)).not.toThrow();
  });
});
